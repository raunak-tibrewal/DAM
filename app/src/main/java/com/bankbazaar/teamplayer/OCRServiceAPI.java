...
public class OCRServiceAPI {
	 ...
	 */
	public boolean convertToText(final String language, final File file) {
		try {
			sendImage(language, file);
		} catch (IOException e) {
			e.printStackTrace();
			return false;
		}
	 ...
	 *  
	 */
	private void sendImage(final String language, final File file) throws ClientProtocolException, IOException {
